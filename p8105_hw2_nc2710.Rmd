...
med_sp_bls = median(sports_balls_2016$sports_balls, na.rm = TRUE) # take the median number of sports balls collected 
...
mean_prcp_16 = mean(precip_data_16$total, na.rm = TRUE) # mean precipitation
sum(precip_data_16$total) # total precipitation

# 2017 precipitation stats
mean_prcp_17 = mean(precip_data_17$total, na.rm = TRUE) # mean precipitation
...
The state with the most observations in the dataset is `r print(most_observed_state)`. 
...
ggplot(brfss_2002, aes(x = excellent)) + 
  ...
  labs(
    ...
    y = "Count",
    caption = "Data from the Behavioral Risk Factors Surveillance System for Selected Metropolitan Area Risk Trends (SMART), 2002, accessed from data.gov in Sept 2018"
  )
